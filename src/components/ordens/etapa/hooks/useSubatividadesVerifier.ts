...
export function useSubatividadesVerifier() {
  // Verificar se as subatividades estão concluídas
  ...
  // Function to merge existing subactivities with new ones, preserving status
